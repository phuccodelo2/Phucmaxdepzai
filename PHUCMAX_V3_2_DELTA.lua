...
containerFrame.Size = UDim2.new(0, 355, 0, 245)
containerFrame.Position = UDim2.new(1, -372, 0.5, -122)
containerFrame.BackgroundColor3 = Color3.fromRGB(16, 40, 96)
...
bountyLabel = pxMakeFallbackLabel(containerFrame, 62, 28, "Bounty: 0", Enum.Font.GothamBold, 22)
timeLabel = pxMakeFallbackLabel(containerFrame, 96, 24, "Runtime: 00:00:00", Enum.Font.GothamSemibold, 18)
statusValueLabel = pxMakeFallbackLabel(containerFrame, 130, 62, "Status: Booting", Enum.Font.GothamMedium, 16)
statusValueLabel.TextYAlignment = Enum.TextYAlignment.Top

local function makeSimpleButton(parent, text, size, pos)
    local btn = Instance.new("TextButton")
    btn.Size = size
    btn.Position = pos
    btn.BackgroundColor3 = Color3.fromRGB(30, 90, 190)
...
local skipButton = makeSimpleButton(containerFrame, "SKIP", UDim2.new(0, 155, 0, 46), UDim2.new(0, 12, 1, -58))
local hopButton = makeSimpleButton(containerFrame, "HOP SERVER", UDim2.new(0, 155, 0, 46), UDim2.new(1, -167, 1, -58))
local toggleButton = makeSimpleButton(screenGui, "UI", UDim2.new(0, 56, 0, 56), UDim2.new(0, 18, 0.5, -28))
...
pcall(function()
    tween = TweenService:Create(containerFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        Position = UDim2.new(1, -372, 0.5, -122)
    })
