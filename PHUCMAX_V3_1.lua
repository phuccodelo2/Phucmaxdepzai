...
local function pxMakeFallbackLabel(parent, posY, sizeY, text, font, textSize)
    local lb = Instance.new("TextLabel")
    lb.BackgroundTransparency = 1
    lb.Size = UDim2.new(1, -24, 0, sizeY)
...
local okUi, uiErr = pcall(function()
    ...
    bountyLabel = pxMakeFallbackLabel(mainCard, 78, 38, "Bounty: 0", Enum.Font.GothamBold, 22)
    timeLabel = pxMakeFallbackLabel(mainCard, 124, 34, "Runtime: 00:00:00", Enum.Font.GothamSemibold, 18)
    ...
    statusValueLabel = pxMakeFallbackLabel(mainCard, 195, 48, "Booting...", Enum.Font.GothamMedium, 16)
    ...
    toggleButton.TextColor3 = Color3.fromRGB(237, 246, 255)
    ...
    local function setUiVisible(state)
        ...
        toggleButton.Text = state and "UI" or ">"
    end
...
if not okUi then
    warn("PHUCMAX UI fallback: " .. tostring(uiErr))
    ...
    containerFrame = Instance.new("Frame")
    containerFrame.Size = UDim2.new(0, 340, 0, 250)
    containerFrame.Position = UDim2.new(1, -360, 0.5, -125)
    containerFrame.BackgroundColor3 = Color3.fromRGB(18, 37, 86)
    containerFrame.Parent = screenGui
    ...
    bountyLabel = pxMakeFallbackLabel(containerFrame, 20, 32, "Bounty: 0", Enum.Font.GothamBold, 22)
    timeLabel = pxMakeFallbackLabel(containerFrame, 65, 28, "Runtime: 00:00:00", Enum.Font.GothamSemibold, 18)
    statusValueLabel = pxMakeFallbackLabel(containerFrame, 108, 100, "Status: fallback UI active", Enum.Font.GothamMedium, 16)
end
