...
pcall(function()
    ...
    local oldBlur = lighting:FindFirstChild("PHUCMAX_Blur")
    if oldBlur then
        oldBlur:Destroy()
    end
end)

local PX_MAIN_IMAGE = "rbxassetid://104878938115988"
local PX_BUTTON_IMAGE = "rbxassetid://104878938115988"
local PX_TOGGLE_IMAGE = "rbxassetid://104878938115988"
...
blurEffect.Name = "PHUCMAX_Blur"
blurEffect.Size = 10
blurEffect.Parent = lighting

local containerFrame = Instance.new("Frame")
containerFrame.Name = "Root"
containerFrame.Size = UDim2.new(1, 0, 1, 0)
containerFrame.BackgroundTransparency = 1
containerFrame.Parent = screenGui

local function makeImageFrame(parent, size, position, imageId, rounded)
    local holder = Instance.new("Frame")
    holder.Size = size
    holder.Position = position
    holder.BackgroundColor3 = Color3.fromRGB(16, 48, 110)
    ...
    corner.CornerRadius = UDim.new(0, rounded or 22)
    corner.Parent = holder

    local stroke = Instance.new("UIStroke")
    stroke.Color = Color3.fromRGB(115, 190, 255)
    ...
    bgCorner.CornerRadius = UDim.new(0, rounded or 22)
    bgCorner.Parent = bg

    local overlay = Instance.new("Frame")
    overlay.BackgroundColor3 = Color3.fromRGB(10, 28, 70)
    overlay.BackgroundTransparency = 0.2
    overlay.Size = UDim2.new(1, 0, 1, 0)
    overlay.Parent = holder

    local overlayCorner = Instance.new("UICorner")
    overlayCorner.CornerRadius = UDim.new(0, rounded or 22)
    overlayCorner.Parent = overlay

    local gradient = Instance.new("UIGradient")
    gradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(28, 94, 195)),
        ColorSequenceKeypoint.new(0.55, Color3.fromRGB(18, 53, 133)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(9, 24, 71))
    }
    ...
    glow.ImageColor3 = Color3.fromRGB(105, 185, 255)
...
uiHolder.Name = "MainUIHolder"
uiHolder.Size = UDim2.new(0, 360, 0, 360)
uiHolder.Position = UDim2.new(1, 380, 0.5, -180)
uiHolder.BackgroundTransparency = 1
uiHolder.Parent = containerFrame

local mainCard = makeImageFrame(uiHolder, UDim2.new(1, 0, 0, 250), UDim2.new(0, 0, 0, 0), PX_MAIN_IMAGE, 26)

local titleLabel = Instance.new("TextLabel")
titleLabel.BackgroundTransparency = 1
titleLabel.Size = UDim2.new(1, -30, 0, 52)
titleLabel.Position = UDim2.new(0, 15, 0, 10)
titleLabel.Font = Enum.Font.GothamBlack
titleLabel.Text = "PHUCMAX"
titleLabel.TextColor3 = Color3.fromRGB(233, 245, 255)
titleLabel.TextScaled = true
titleLabel.Parent = mainCard

local bountyLabel = Instance.new("TextLabel")
bountyLabel.BackgroundTransparency = 1
bountyLabel.Size = UDim2.new(1, -36, 0, 38)
bountyLabel.Position = UDim2.new(0, 18, 0, 78)
bountyLabel.Font = Enum.Font.GothamBold
bountyLabel.TextXAlignment = Enum.TextXAlignment.Left
bountyLabel.Text = "Bounty: 0"
bountyLabel.TextColor3 = Color3.fromRGB(228, 241, 255)
bountyLabel.TextSize = 22
bountyLabel.Parent = mainCard

local timeLabel = Instance.new("TextLabel")
timeLabel.BackgroundTransparency = 1
timeLabel.Size = UDim2.new(1, -36, 0, 34)
timeLabel.Position = UDim2.new(0, 18, 0, 124)
timeLabel.Font = Enum.Font.GothamSemibold
timeLabel.TextXAlignment = Enum.TextXAlignment.Left
timeLabel.Text = "Runtime: 00:00:00"
timeLabel.TextColor3 = Color3.fromRGB(214, 233, 255)
timeLabel.TextSize = 18
timeLabel.Parent = mainCard

local statusTitleLabel = Instance.new("TextLabel")
statusTitleLabel.BackgroundTransparency = 1
statusTitleLabel.Size = UDim2.new(1, -36, 0, 26)
statusTitleLabel.Position = UDim2.new(0, 18, 0, 168)
statusTitleLabel.Font = Enum.Font.GothamBold
statusTitleLabel.TextXAlignment = Enum.TextXAlignment.Left
statusTitleLabel.Text = "Status"
statusTitleLabel.TextColor3 = Color3.fromRGB(180, 215, 255)
statusTitleLabel.TextSize = 19
statusTitleLabel.Parent = mainCard

local statusValueLabel = Instance.new("TextLabel")
statusValueLabel.BackgroundTransparency = 1
statusValueLabel.Size = UDim2.new(1, -36, 0, 48)
statusValueLabel.Position = UDim2.new(0, 18, 0, 195)
statusValueLabel.Font = Enum.Font.GothamMedium
statusValueLabel.TextWrapped = true
statusValueLabel.TextYAlignment = Enum.TextYAlignment.Top
statusValueLabel.TextXAlignment = Enum.TextXAlignment.Left
statusValueLabel.Text = "Booting..."
statusValueLabel.TextColor3 = Color3.fromRGB(240, 247, 255)
statusValueLabel.TextSize = 16
statusValueLabel.Parent = mainCard

local buttonRow = Instance.new("Frame")
buttonRow.Name = "ButtonRow"
buttonRow.Size = UDim2.new(1, 0, 0, 84)
buttonRow.Position = UDim2.new(0, 0, 0, 272)
buttonRow.BackgroundTransparency = 1
buttonRow.Parent = uiHolder

local function createActionButton(parent, text, posX)
    local holder = makeImageFrame(parent, UDim2.new(0, 172, 0, 58), UDim2.new(0, posX, 0, 0), PX_BUTTON_IMAGE, 20)
    local btn = Instance.new("TextButton")
    btn.BackgroundTransparency = 1
    btn.Size = UDim2.new(1, 0, 1, 0)
    btn.Font = Enum.Font.GothamBold
    btn.Text = text
    btn.TextColor3 = Color3.fromRGB(237, 246, 255)
    btn.TextSize = 20
...
local skipButton = createActionButton(buttonRow, "SKIP", 0)
local hopButton = createActionButton(buttonRow, "HOP SERVER", 188)

local toggleHolder = makeImageFrame(containerFrame, UDim2.new(0, 58, 0, 58), UDim2.new(0, 18, 0.5, -29), PX_TOGGLE_IMAGE, 18)
...
toggleText.Text = "UI"
toggleText.TextColor3 = Color3.fromRGB(237, 246, 255)
...
local function setUiVisible(state)
    uiVisible = state
    uiHolder.Visible = state
    blurEffect.Size = state and 10 or 0
    toggleText.Text = state and "UI" or ">"
end
...
local enterTween = TweenService:Create(uiHolder, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    Position = UDim2.new(1, -385, 0.5, -180)
})
enterTween:Play()
...
pxLog("PHUCMAX V3 core loaded", "BOOT")
...
-- === PHUCMAX V3 NOTES ===
-- V3 thiết kế lại UI tông xanh dương với nút toggle bên trái, thẻ chính và hai nút Skip / Hop Server.
-- V3 cũng tối ưu logic đổi tool: chỉ đổi khi tool hiện tại đã hết skill khả dụng và có tool khác đang sẵn skill.
-- Thêm kiểm tra safe zone liên tục để bỏ mục tiêu trong vùng an toàn và ưu tiên săn mục tiêu đang ở ngoài.
